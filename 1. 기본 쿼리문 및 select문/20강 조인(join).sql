...
select a1.empno, a1.ename, a3.grade
from emp a1, dept a2, salgrade a3
where a1.deptno = a2.deptno and a2.dname = 'SALES'
        and a1.sal between a3.losal and a3.hisal;

--각 급여 등급별 급여의 총합과 평균, 사원의수, 최대급여, 최소급여를 가져온다.
select a2.grade, sum(a1.sal), round(avg(a1.sal)), count(a1.sal), max(a1.sal), min(a1.sal)
from emp a1, salgrade a2
where a1.sal between a2.losal and a2.hisal
group by a2.grade
order by a2.grade;
...
where a1.sal between a2.losal and a2.hisal and a2.grade = 4
